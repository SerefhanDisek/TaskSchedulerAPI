...
namespace TaskSchedulerAPI.DataAccess.Migrations
{
    ...
    [Migration("20240828055441_AddAssignedUserIdToTasks")]
    partial class AddAssignedUserIdToTasks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskSchedulerAPI.Core.Entities.Tasks", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 8, 28, 5, 54, 40, 663, DateTimeKind.Utc).AddTicks(552),
                            Description = "Complete the first task",
                            DueDate = new DateTime(2024, 9, 4, 5, 54, 40, 663, DateTimeKind.Utc).AddTicks(545),
                            IsCompleted = false,
                            Name = "Task 1"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 8, 28, 5, 54, 40, 663, DateTimeKind.Utc).AddTicks(555),
                            Description = "Start the second task",
                            DueDate = new DateTime(2024, 9, 11, 5, 54, 40, 663, DateTimeKind.Utc).AddTicks(554),
                            IsCompleted = false,
                            Name = "Task 2"
                        });
                });
