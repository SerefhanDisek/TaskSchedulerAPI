            ...
            modelBuilder.Entity("TaskSchedulerAPI.Core.Entities.Tasks", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 8, 26, 14, 4, 6, 619, DateTimeKind.Utc).AddTicks(6701),
                            Description = "Complete the first task",
                            DueDate = new DateTime(2024, 9, 2, 14, 4, 6, 619, DateTimeKind.Utc).AddTicks(6691),
                            IsCompleted = false,
                            Name = "Task 1"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 8, 26, 14, 4, 6, 619, DateTimeKind.Utc).AddTicks(6704),
                            Description = "Start the second task",
                            DueDate = new DateTime(2024, 9, 9, 14, 4, 6, 619, DateTimeKind.Utc).AddTicks(6703),
                            IsCompleted = false,
                            Name = "Task 2"
                        });
                });
