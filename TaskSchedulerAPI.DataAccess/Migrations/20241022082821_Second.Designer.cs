...
namespace TaskSchedulerAPI.DataAccess.Migrations
{
    ...
    [Migration("20241022082821_Second")]
            ...
            modelBuilder.Entity("TaskSchedulerAPI.Core.Entities.Tasks", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 22, 8, 28, 20, 585, DateTimeKind.Utc).AddTicks(2908),
                            Description = "Complete the first task",
                            DueDate = new DateTime(2024, 10, 29, 8, 28, 20, 585, DateTimeKind.Utc).AddTicks(2899),
                            IsCompleted = false,
                            Name = "Task 1",
                            Priority = "Oncelikli"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 22, 8, 28, 20, 585, DateTimeKind.Utc).AddTicks(2911),
                            Description = "Start the second task",
                            DueDate = new DateTime(2024, 11, 5, 8, 28, 20, 585, DateTimeKind.Utc).AddTicks(2911),
                            IsCompleted = false,
                            Name = "Task 2",
                            Priority = "Oncelikli"
                        });
