            ...
            modelBuilder.Entity("TaskSchedulerAPI.Core.Entities.Tasks", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 8, 28, 10, 28, 5, 897, DateTimeKind.Utc).AddTicks(7478),
                            Description = "Complete the first task",
                            DueDate = new DateTime(2024, 9, 4, 10, 28, 5, 897, DateTimeKind.Utc).AddTicks(7472),
                            IsCompleted = false,
                            Name = "Task 1"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 8, 28, 10, 28, 5, 897, DateTimeKind.Utc).AddTicks(7481),
                            Description = "Start the second task",
                            DueDate = new DateTime(2024, 9, 11, 10, 28, 5, 897, DateTimeKind.Utc).AddTicks(7480),
                            IsCompleted = false,
                            Name = "Task 2"
                        });
                });
