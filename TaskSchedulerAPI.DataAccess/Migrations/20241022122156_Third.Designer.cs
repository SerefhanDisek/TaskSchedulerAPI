...
namespace TaskSchedulerAPI.DataAccess.Migrations
{
    ...
    [Migration("20241022122156_Third")]
    partial class Third
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskSchedulerAPI.Core.Entities.Tasks", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 10, 22, 12, 21, 55, 43, DateTimeKind.Utc).AddTicks(9841),
                            Description = "Complete the first task",
                            DueDate = new DateTime(2024, 10, 29, 12, 21, 55, 43, DateTimeKind.Utc).AddTicks(9833),
                            IsCompleted = false,
                            Name = "Task 1",
                            Priority = "Oncelikli"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 10, 22, 12, 21, 55, 43, DateTimeKind.Utc).AddTicks(9844),
                            Description = "Start the second task",
                            DueDate = new DateTime(2024, 11, 5, 12, 21, 55, 43, DateTimeKind.Utc).AddTicks(9843),
                            IsCompleted = false,
                            Name = "Task 2",
                            Priority = "Oncelikli"
                        });
